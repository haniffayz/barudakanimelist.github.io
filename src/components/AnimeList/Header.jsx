...
const Header = ( {title, linkHref, linkTitle} ) => {
    ...
    <div className="flex justify-between items-center p-6 md:p-6 py-7 md:py-10 bg-colos-accent dark:bg-colos-sidebarColor">
      ...
      {
      linkHref && linkTitle ?
      <div className="border border-black border-solid border-1 w-28 md:w-32 rounded-xl hover:bg-colos-secondary h-7">
        <CaretDown size={20} className="cursor-pointer absolute right-8 mt-1" />
    <Link 
      href={linkHref} 
